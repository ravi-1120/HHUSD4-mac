...
!(function (a, b) {
  var  eventName ='',productName='',url ='',urltext='';
    function c(a) {
    ...
    b.fn.pagination && (g = "pagination2"),
                ...
                l = {
                    ...
                    generatePageNumbersHTML: function (a) {
                        var b,
                            ...
                            console.log('paginationnn 1>>>',b);
                            console.log('paginationnn 2>>>',c);
                            console.log('paginationnn 3>>>',d);
                            console.log('paginationnn 4>>>',e);
                            console.log('paginationnn 5>>>',f);
                            console.log('paginationnn 6>>>',g);
                            console.log('paginationnn 7>>>',h);
                            console.log('paginationnn 8>>>',i);
                            console.log('paginationnn 9>>>',j);
                            console.log('paginationnn 10>>>',l);
                            console.log('paginationnn 11>>>',m);
                            console.log('paginationnn 12>>>',n);                             

                            console.log(screen.width);
                            console.log(window.screen.width);
                            if(screen.width < 768){
                                 var g  = a.rangeEnd - 1
                                // var f = a.rangeStart + 1
                        ...
                        if (f <= 3)
                            ...
                            k.showFirstOnEllipsisShow &&
                                (h += '<li class="' + l + "-page " + l + '-first J-paginationjs-page" data-num="1" ><a >1</a></li>'),
                        ...
                        if (g >= e - 2)
                            ...
                            (h +=
                                ...
                                (h +=
                                    ...
                                    e +
                                    "</a></li>");
                            console.log('OUTPUT h: ',h);
							let finalPglist='';
							let paginationItems = [];
							paginationItems= h.split('</li>');
							for(let pg= 0;  pg < paginationItems.length; pg++ ){
								
									if(screen.width < 768){
										if(paginationItems[pg].includes(d) || paginationItems[pg].includes(d+1) ){
											finalPglist += paginationItems[pg]+'</li>';
										}
									}else{
										finalPglist += paginationItems[pg]+'</li>';
										...
										else if( ( paginationItems[pg].includes(d) || paginationItems[pg].includes(d+1) ||paginationItems[pg].includes(d+2) ||paginationItems[pg].includes(d+3) || paginationItems[pg].includes(d+4) ) &&  paginationItems.length - d  > 5 ){
												finalPglist += paginationItems[pg]+'</li>';
										}
										else if( ( paginationItems[pg].includes(d) || paginationItems[pg].includes(d+1) ||paginationItems[pg].includes(d+2) ||paginationItems[pg].includes(d+3) || paginationItems[pg].includes(d+4) ) &&  paginationItems.length - d  > 5 ){
												finalPglist += paginationItems[pg]+'</li>';
                    ...
                    generateHTML: function (a) {
                        var c,
							...
							PR = screen.width < 768 ? '<span class="arrow-align"><span class="pagination-arrow">&#8592;</span> <span >  </span> </span>' : '<span ><span class="pagination-arrow">&#8592;</span> <span style="margin-left: 16px;" > Previous </span> </span>'  ;
							NX	= 	screen.width < 768 ? '<span class="arrow-align"> <span > </span><span class="pagination-arrow">&#8594;</span></span>' : '<span > <span style="margin-right: 16px;"> Next </span><span class="pagination-arrow">&#8594;</span></span>' ;					
                        return (
                            D &&
                            ...
                            ((v += '<div class="paginationjs-pages">'),
                                ...
                                (e <= 1
                                    ...
                                    (v +=
                                        ...
                                        t +
                                        '"><a >' +
                                        // '&nbsp;<span class="pagination-nav">&nbsp;Previous&nbsp; &nbsp;</span>' +
                                       PR +
                                        "</a></li>")
                                    : (v +=
                                        '<li class="' +
                                        ...
                                        (e - 1) +
                                        '"  ><a >' +
                                        // '&nbsp;<span class="pagination-nav"><span class="pagination-arrow">&#8592;</span>&nbsp;Previous&nbsp; &nbsp;</span>' +
                                       PR +
                                        "</a></li>")),
                                ...
                                (e >= f
                                    ...
                                    : (v +=
                                        ...
                                        (e + 1) +
                                        '" ><a   >' +
                                        // '&nbsp;<span class="pagination-nav">&nbsp;Next&nbsp;<span class="pagination-arrow">&#8594;</span> &nbsp;</span>' +
                                        NX +
                                        "</a></li>")),
                                (v += "</ul></div>")),
                            l &&
                    ...
                    go: function (a, c) {
                        function d(a) {
                            ...
                            (j.data("pagination").currentPageData = a),
                                e.doCallback(a, c,i,q,k.eventName,k.productName,k.url,k.urltext),     //Added i,q for GA
                    ...
                    doCallback: function (a, c,i,q,eventName,productName,url,urltext) {   //Added i,q for GA
                        var d = this,
                            e = d.model;
                        b.isFunction(c)
                            ? c(a, e)
                            : b.isFunction(k.callback) && k.callback(a, e,i,q,eventName,productName,url,urltext); //Added i,q for GA
                    },
                    destroy: function () {
        ...
        (b[g] = function (a, d) {
            ...
            if (
                ...
                return e.pagination(d,'Test1','Test2'), e;
        });
    var i = {};
