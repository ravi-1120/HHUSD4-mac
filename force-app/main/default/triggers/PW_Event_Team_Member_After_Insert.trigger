trigger PW_Event_Team_Member_After_Insert on EM_Event_Team_Member_vod__c (after insert) {
    
    System.Debug('Event Team Member insert after trigger');
    //String triggerEvent ='';
    if (Trigger.isInsert)
    {
        //triggerEvent ='INSERT';
       ...
       // PW_Identify_Cohost_Organiser_Role pw_team_member_role=new PW_Identify_Cohost_Organiser_Role();  //---New
        ...
        for (EM_Event_Team_Member_vod__c eventTeamMember : Trigger.new) 
        {
            ...
            try{           
                System.Debug('Event Team Member Insert after trigger called for id ='+eventTeamMember .id);  
                ...
                System.Debug(' Event Team member Insert after trigger exception');  
