trigger VOD_MC_CYCLE_PLAN_SUMMARY_BEFORE_UPDATE_DELETE on MC_Cycle_Plan_Summary_vod__c (before update, before delete) {
    ...
    for(MC_Cycle_Plan_Summary_vod__c summary: Trigger.old){
    ...
    for(Integer i = 0; i< Trigger.old.size(); i++){
        MC_Cycle_Plan_Summary_vod__c oldPlan = Trigger.old[i];
