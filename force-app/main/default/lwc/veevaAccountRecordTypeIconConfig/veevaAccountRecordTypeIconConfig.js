export default class VeevaAccountRecordTypeIconConfig {
    ...
    getIconUrlForRecordType(recordType, isPersonAccount, isInTerr, defaultIcon){
        ...
        if (VeevaAccountRecordTypeIconConfig.STANDARD_RECTYPE_ICON_MAP.has(recordType)){
            iconName = VeevaAccountRecordTypeIconConfig.STANDARD_RECTYPE_ICON_MAP.get(recordType);
        } else if (this._customRecordTypeIconMap.has(recordType)){
            iconName = VeevaAccountRecordTypeIconConfig.STANDARD_RECTYPE_ICON_MAP.get(this._customRecordTypeIconMap.get(recordType));
        } 
        if (!iconName) {
            if (defaultIcon) {
