...
import getPicklist from '@salesforce/apex/MSD_CORE_HEQ_Addmore.getPicklist';
import HEQ_Icon_1 from '@salesforce/resourceUrl/MSD_CORE_HEQ_Icon_1';
import closeIcon from '@salesforce/resourceUrl/MSD_CORE_HEQ_Utility_Icon_1';
//import getUser from '@salesforce/apex/HEQ_HeaderController.getuser';
import saveUserPreferences from '@salesforce/apex/MSD_CORE_HEQ_Addmore.saveUserPreferences';
import getUserPreferences from '@salesforce/apex/MSD_CORE_HEQ_Addmore.getUserPreferences';
import HEQ_Topics from '@salesforce/resourceUrl/MSD_CORE_HEQ_Topics';
import HEQ_Therapeutic_Area from '@salesforce/resourceUrl/MSD_CORE_HEQ_T_Area';
import HEQ_New from '@salesforce/resourceUrl/MSD_CORE_HEQ_New';
import HEQ_Expiring_Soon from '@salesforce/resourceUrl/MSD_CORE_HEQ_Expiring_Soon';
import HEQ_Collections from '@salesforce/resourceUrl/MSD_CORE_HEQ_Collections';
import HEQ_DI_Artbanks from '@salesforce/resourceUrl/MSD_CORE_HEQ_DI_Artbanks';

export default class MSD_CORE_HEQ_AddMore extends LightningElement {
    ...
    fetchFieldValuesByProfile(profileName) {
        ...
        const metadataType = 'MSD_CORE_HEQ_Portal_Setting__mdt';
        const fieldNames = ['MSD_CORE_HEQ_Categories__c'];
        ...
        getPicklist({ metadataType, recordApiName: profileName, fieldNames })
            .then(result => {
                ...
                if (result.MSD_CORE_HEQ_Categories__c) {
                    this.heqCategoriesOptions = this.processFieldValues(result.MSD_CORE_HEQ_Categories__c);
                    console.log('MSD_CORE_HEQ_Categories__c:', this.heqCategoriesOptions);
                    ...
                    console.warn('MSD_CORE_HEQ_Categories__c is not present in the result:', result);
                }
            })
            .catch(error => {
