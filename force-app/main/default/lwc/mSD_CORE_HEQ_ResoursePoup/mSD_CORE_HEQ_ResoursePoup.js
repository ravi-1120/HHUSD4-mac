...
export default class MSD_CORE_HEQ_ResoursePoup extends LightningElement {
    ...
    connectedCallback() {
        ...
        console.log('Browse popup' + this.type);
        if (this.type == 'Browse All') {
            console.log('Browse popup');
    ...
    handleDocumentSelection(event) {
        ...
        console.log('Selected Resources from Popup >>', JSON.stringify(this.sections));
    }

    handleExpandCollapsSidebar(){
        console.log('handleExpandCollapsSidebar');
