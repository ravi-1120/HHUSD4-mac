({
    MAX_FILE_SIZE: 21000000, //Max file size 4.5 MB 
    ...
    doInit :  function(component, event, helper){
        ...
        action.setCallback(this,function(response){  
            ...
            if(state=='SUCCESS'){ 
                ...
                console.log("attachment"+ JSON.stringify(response.getReturnValue()));
            }
        });  
    ...
    uploadHelper: function(component, event) {
        ...
        console.log("file to be uploaded --->" + JSON.stringify(fileInput));
    ...
    uploadInChunk: function(component, file, fileContents, startPosition, endPosition, attachId) {
        ...
        action.setParams({
            ...
            fileId: attachId,
            attType : component.get("v.attType")
        });
        ...
        action.setCallback(this, function(response) {
            ...
            if (state === "SUCCESS") {
                ...
                if (startPosition < endPosition) {
                    ...
                    window.location.href = "/lightning/r/Knowledge__kav/"+ component.get("v.recordId") +"/view";
                }
